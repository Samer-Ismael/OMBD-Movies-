...
public class OMBD {
    ...
    public void getDataByTitle(String apiKey, String movieTitle) {
    ...
    public JSONArray getDataByYear(String apiKey, String year) {

        return null;
    }

    private void jsonToString(StringBuffer answer) {
    ...
    public void printMovie() {
        ...
        System.out.println("Actors: " + getActor());
    }
